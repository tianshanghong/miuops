...
echo "=============================================="
echo ""
echo "1. Add the .env values above to your stack repo's ENV_FILE secret"
echo "2. Build the postgres-walg image:"
echo "   docker build -t postgres-walg:17 images/postgres-walg/"
echo "3. Push the image to your container registry"
echo "4. Add a host cron job for daily base backups:"
echo "   0 3 * * * cd /opt/stacks/myapp && docker compose exec -T -u postgres db walg-backup.sh"
echo "5. Set up backup encryption — see docs/BACKUP_ENCRYPTION.md"
